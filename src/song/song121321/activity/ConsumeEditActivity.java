...
public class ConsumeEditActivity extends BaseActivity implements
        OnClickListener {
    ...
    private ConsumeDto singleConsumeDto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyApplication.getInstance().addActivity(ConsumeEditActivity.this);
        findView();
        initView();
        initData();
        setListener();
    ...
    private void initView() {
        ...
        rlAssert.setEnabled(false);
        rlBudget.setEnabled(false);
        rlCtype.setEnabled(false);
    }

    private void initData() {
        Intent intent = this.getIntent();
        singleConsumeDto = (ConsumeDto) intent.getSerializableExtra("singleConsume");
        etDesc.setText(singleConsumeDto.getDescp());
        etJe.setText(singleConsumeDto.getJe() + "");
        etDetail.setText(singleConsumeDto.getDetail());
        tvActionbarTitle.setText(singleConsumeDto.getDescp());
        tvAssertTemp.setText(singleConsumeDto.getBank_descp());
        tvBudgetTemp.setText(singleConsumeDto.getBudget_descp());
        tvCtypeTemp.setText(singleConsumeDto.getConsumetype().getDescp());
        tvActionbarCancel.setText(R.string.system_return);
        tvActionbarSure.setVisibility(View.INVISIBLE);
    }
    ...
    private void showBudgetDialog(final List<BudgetDto> result) {
        ...
        mBuilder = new MaterialDialog.Builder(ConsumeEditActivity.this);
        mBuilder.title("选择预算");
